...
import { areSourceEntriesNewestFirst, buildPlaylistSourceManifest, findDurableSourceOverlap, inferredRemovedSourceEntries, parsePlaylistSourceManifest, sourceEntriesFromSpotify } from './playlist-source-manifest';
...
describe('playlist source manifests', () => {
    ...
    it('rejects a non-monotonic Liked Songs boundary', () => {
        ...
        expect(areSourceEntriesNewestFirst(entries)).toBe(false);
    });
