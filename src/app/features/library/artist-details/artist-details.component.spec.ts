...
describe('ArtistDetailsComponent', () => {
        ...
        TestBed.configureTestingModule({
            ...
            providers: [
                ...
                },
                {
                    ...
                    useValue: { getItem: () => null, setItem: vi.fn().mockName('setItem') }
                },
    ...
    it('keeps artist B visible when artist A finishes later', async () => {
        ...
        const routed = new ArtistDetailsComponent({ params } as any, { getSingleArtist: () => of(null) } as any, { navigate: vi.fn().mockName('navigate') } as any, { getUserId: () => 'user-id', isBackupActive: () => false } as any, { getItem: () => null, setItem: vi.fn().mockName('setItem') } as any, { loadArtistById: (id: string) => new Promise(resolve => pending.set(id, resolve)) } as any);
