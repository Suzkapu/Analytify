...
describe('AppComponent', () => {
    ...
    it('should keep the announcement visible on the landing page', async () => {
        const fixture = TestBed.createComponent(AppComponent);
    ...
    it('should briefly show the announcement on other pages and then hide it', async () => {
        const fixture = TestBed.createComponent(AppComponent);
        await vi.advanceTimersByTimeAsync(0);
        fixture.componentInstance.siteAnnouncement = 'Scheduled maintenance';
    ...
    it('does not warn when a navigation is superseded by a newer navigation', () => {
        ...
        routerEvents.next(new NavigationCancel(2, '/playlists', 'A newer navigation replaced this one.', NavigationCancellationCode.SupersededByNewNavigation));
