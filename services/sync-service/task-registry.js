...
const TASK_DEFINITIONS = {
  listening_history: {enabledField: 'history_enabled', intervalField: 'history_interval_minutes', intervalUnit: 'minutes'},
  stats_short_term: {enabledField: 'short_term_enabled', intervalField: 'short_term_interval_hours', intervalUnit: 'hours'},
  stats_medium_term: {enabledField: 'medium_term_enabled', intervalField: 'medium_term_interval_hours', intervalUnit: 'hours'},
  stats_long_term: {enabledField: 'long_term_enabled', intervalField: 'long_term_interval_hours', intervalUnit: 'hours'},
...
function intervalMilliseconds(taskKey, settings) {
  ...
  return value * (definition.intervalUnit === 'hours' ? 3_600_000 : 60_000);
}
