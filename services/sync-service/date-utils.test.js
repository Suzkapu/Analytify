...
const {dailyCutoff, snapshotDate, isFridayInTimezone} = require('./date-utils');
...
test('detects Friday in the configured timezone', () => {
  assert.equal(isFridayInTimezone(new Date('2026-09-03T22:30:00.000Z'), 'Europe/Vienna'), true);
  assert.equal(isFridayInTimezone(new Date('2026-09-04T22:30:00.000Z'), 'Europe/Vienna'), false);
});
